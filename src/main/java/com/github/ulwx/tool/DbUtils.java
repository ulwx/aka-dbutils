...
public class DbUtils extends BaseDao {
    ...
    public static <T> List<T> queryList(String dbpoolName, Class<T> clazz, String sqlPrefix, String sqlQuery, Map<Integer, Object> vParameters, QueryMapNestOne2One[] queryMapNestList) throws DbException {
        return execute(db -> {
    ...
    public static <T> List<T> queryList(String dbpoolName, Class<T> clazz, String sqlPrefix, String sqlQuery, Map<Integer, Object> vParameters, QueryMapNestOne2One[] queryMapNestList, int page, int perPage, PageBean pageUtils, String countSql) throws DbException {
        return execute(db -> {
            return db.queryList(clazz, sqlPrefix, sqlQuery, vParameters, queryMapNestList, page, perPage, pageUtils, countSql);
        }, dbpoolName);
    }

    public static <T> List<T> queryList(String dbpoolName, Class<T> clazz, String sqlPrefix, String beanKey, String sqlQuery, Map<Integer, Object> vParameters, QueryMapNestOne2Many[] queryMapNestList) throws DbException {
        return execute(db -> {
    ...
    public static String exeScript(String dbpoolName, Reader reader, PrintWriter logWriter) throws DbException {
        return execute(db -> {
            return db.exeScript(reader, logWriter);
        }, dbpoolName);
    }

    public static String exeScript(String dbpoolName, Reader reader) throws DbException {
        return execute(db -> {
