...
import static com.github.ulwx.aka.dbutils.tool.support.deepequal.Converter.convert2BigDecimal;
import static com.github.ulwx.aka.dbutils.tool.support.deepequal.Converter.convert2boolean;
import static com.github.ulwx.aka.dbutils.tool.support.deepequal.ReflectionUtils.getClassLoaderName;
...
public class DeepEquals {
    ...
    public static boolean deepEquals(Object a, Object b, Map<?, ?> options) {
        ...
        while (!stack.isEmpty()) {
            ...
            } else if (key2 instanceof Collection) {   // They both must be Collection
                return false;
            }
