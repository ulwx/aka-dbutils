...
public abstract class Assert {
    ...
    private static void notEmpty(Object array, String message) {
        ...
        Assert.state(c.isArray(),
                "[Assertion failed] - parmater must be a array object");
    ...
    public static void equal(Object src, Object des) {
        if (!ObjectUtils.deepEquals(src, des)) {
            throw new IllegalStateException("src[" + src + "] is not equal to des[" + des + "]");
        }
