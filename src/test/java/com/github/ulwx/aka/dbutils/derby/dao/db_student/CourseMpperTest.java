...
public class CourseMpperTest {
    ...
    public void testAddCourse() {
      LocalDateTime localDateTime= LocalDateTime.parse("2021-03-15 22:31:48", CTime.DTF_YMD_HH_MM_SS);
        ...
        DbContext.removeDebugSQLListener();
        Assert.equal(sql.toString(), "INSERT INTO \"course\" ( \"name\", \"class_hours\", \"creatime\" ) VALUES ( 'abcdefg', 45, timestamp('2021-03-15 22:31:48') )");
    ...
    public void testUpdateCourse() {
      LocalDateTime localDateTime= LocalDateTime.parse("2021-03-15 22:31:48", CTime.DTF_YMD_HH_MM_SS);
        ...
        Assert.equal(sql.toString(), "UPDATE \"course\" SET \"name\" = 'abcdefg', \"class_hours\" = 45, \"creatime\" = timestamp('2021-03-15 22:31:48') WHERE \"id\" = 3");
        courseMpper.updateCourse(course);
        Assert.equal(sql.toString(), "UPDATE \"course\" SET \"name\" = 'abcdefg', \"class_hours\" = 45, \"creatime\" = timestamp('2021-03-15 22:31:48') WHERE \"id\" = 3");
