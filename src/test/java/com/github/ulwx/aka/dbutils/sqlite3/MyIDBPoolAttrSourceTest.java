...
public class MyIDBPoolAttrSourceTest implements IDBPoolAttrSource {
    ...
    public void configProperties(Map<String, String> masterProperties,
        ...
        slave1.put("driverClassName","org.sqlite.JDBC");
        slave1.put("url","jdbc:sqlite:D:/suncj/sqllite/db_teacher_slave1.db");
        ...
        slave2.put("driverClassName","org.sqlite.JDBC");
        slave2.put("url","jdbc:sqlite:D:/suncj/sqllite/db_teacher_slave2.db");
