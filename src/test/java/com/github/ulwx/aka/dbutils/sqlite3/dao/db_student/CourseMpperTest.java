...
public class CourseMpperTest {
    ...
    static String createTime =
            LocalDateTime.parse("2021-03-15 22:31:48", CTime.DTF_YMD_HH_MM_SS).format(CTime.DTF_YMD_HH_MM_SS);
    ...
    public void testGetCourseListByIds() {
        ...
        String  localDateTime = LocalDateTime.parse("2021-03-15 22:31:48", CTime.DTF_YMD_HH_MM_SS).format(CTime.DTF_YMD_HH_MM_SS);
