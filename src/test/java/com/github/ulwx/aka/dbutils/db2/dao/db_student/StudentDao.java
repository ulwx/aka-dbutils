...
import com.github.ulwx.aka.dbutils.db2.domain.cus.MyStudent;
import com.github.ulwx.aka.dbutils.db2.domain.cus.One2ManyStudent;
import com.github.ulwx.aka.dbutils.db2.domain.cus.One2OneStudent;
import com.github.ulwx.aka.dbutils.db2.domain.db.db_student.Course;
import com.github.ulwx.aka.dbutils.db2.domain.db.db_student.Student;
...
public class StudentDao {
    ...
    public void testQueryListOne2OnePage() {
        ...
        DbContext.removeDebugSQLListener();
        Assert.equal(sql.toString(),
                "select count(1) from \"student\" stu,\"student_course\" sc,\"course\" c where stu.\"id\"=sc.\"student_id\"and c.\"id\"=sc.\"course_id\" and stu.\"name\" in ('student1','student2','student3','student4','student5','student6','student7','student8','student9');select * from ( select inner2_.*, rownumber() over(order by order of inner2_) as rownumber_ from ( select stu.\"id\" as \"stu.id\", stu.\"name\" as \"stu.name\", stu.\"age\" as \"stu.age\", stu.\"birth_day\" as \"stu.birth_day\", c.\"id\" as \"c.id\", c.\"name\" as \"c.name\", c.\"class_hours\" as \"c.class_hours\", c.\"teacher_id\" as \"c.teacher_id\", c.\"creatime\" as \"c.creatime\" from \"student\" stu,\"student_course\" sc,\"course\" c where stu.\"id\"=sc.\"student_id\"and c.\"id\"=sc.\"course_id\" and stu.\"name\" in ('student1','student2','student3','student4','student5','student6','student7','student8','student9') order by stu.\"id\" fetch first 6 rows only ) as inner2_ ) as inner1_ where rownumber_ > 3 order by rownumber_");
    ...
    public void testQueryListOne2ManyPage() {
        ...
        Assert.equal(sql.toString(),
                "select count(1) from (select stu.\"id\" as \"value\" from \"student\" stu,\"student_many_courses\" sc,\"course\" c where stu.\"id\"=sc.\"student_id\"and c.\"id\"=sc.\"course_id\" and stu.\"name\" in ('student1','student4','student6','student7','student9','student10') group by stu.\"id\") t;select * from ( select inner2_.*, rownumber() over(order by order of inner2_) as rownumber_ from ( select stu.\"id\" as \"value\" from \"student\" stu,\"student_many_courses\" sc,\"course\" c where stu.\"id\"=sc.\"student_id\"and c.\"id\"=sc.\"course_id\" and stu.\"name\" in ('student1','student4','student6','student7','student9','student10') group by stu.\"id\" order by stu.\"id\" fetch first 6 rows only ) as inner2_ ) as inner1_ where rownumber_ > 3 order by rownumber_");
        sql.setLength(0);
        args.put("ids", ids);
