package com.github.ulwx.aka.dbutils.mariadb;
...
public class MyIDBPoolAttrSourceTest implements IDBPoolAttrSource {
    ...
    public void configProperties(Map<String, String> masterProperties,
        ...
        try {
            MDbUtils.queryOneBy("mariadb/dbpool.xml#db_teacher", new Teacher());
        }catch (Exception e){
            log.error("",e);
        }

        masterProperties.put("driverClassName","com.mysql.cj.jdbc.Driver");
        masterProperties.put("url","jdbc:mysql://192.168.137.200:3307/db_teacher?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true&allowPublicKeyRetrieval=true");
        ...
        slave1.put("url","jdbc:mysql://192.168.137.200:3307/db_teacher_slave1?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true&allowPublicKeyRetrieval=true");
        ...
        slave2.put("url","jdbc:mysql://192.168.137.200:3307/db_teacher_slave2?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true&allowPublicKeyRetrieval=true");
