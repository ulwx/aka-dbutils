...
public class MyIDBPoolAttrSourceTest implements IDBPoolAttrSource {
    ...
    public void configProperties(Map<String, String> masterProperties,
        ...
        masterProperties.put("url","jdbc:mysql://192.168.137.200:3307/db_teacher?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true");
        ...
        slave1.put("url","jdbc:mysql://192.168.137.200:3307/db_teacher_slave1?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true");
        ...
        slave2.put("url","jdbc:mysql://192.168.137.200:3307/db_teacher_slave2?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true");
