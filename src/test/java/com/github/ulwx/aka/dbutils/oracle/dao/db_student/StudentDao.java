...
import com.github.ulwx.aka.dbutils.oracle.domain.cus.MyStudent;
import com.github.ulwx.aka.dbutils.oracle.domain.cus.One2ManyStudent;
import com.github.ulwx.aka.dbutils.oracle.domain.cus.One2OneStudent;
...
public class StudentDao {
    ...
    public void testQueryListOne2One() {
        ...
        compared.setAge(40);
        compared.setBirthDay(LocalDateTime.parse("1980-10-08 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        ...
        compared.setAge(39);
        compared.setBirthDay(LocalDateTime.parse("1981-11-01 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        compared.setCourse(new Course());
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDateTime.parse("1982-10-08 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        compared.setCourse(new Course());
    ...
    public void testQueryListOne2OnePage() {
        ...
        DbContext.removeDebugSQLListener();
        Assert.equal(sql.toString(),
                "select count(1) from \"student\" stu,\"student_course\" sc,\"course\" c where stu.\"id\"=sc.\"student_id\" and c.\"id\"=sc.\"course_id\" and stu.\"name\" in ('student1','student2','student3','student4','student5','student6','student7','student8','student9');select * from ( select row_.*, rownum rownum_ from ( select stu.\"id\" as \"stu@id\", stu.\"name\" as \"stu@name\", stu.\"age\" as \"stu@age\", stu.\"birth_day\" as \"stu@birth_day\", c.\"id\" as \"c@id\", c.\"name\" as \"c@name\", c.\"class_hours\" as \"c@class_hours\", c.\"teacher_id\" as \"c@teacher_id\", c.\"creatime\" as \"c@creatime\" from \"student\" stu,\"student_course\" sc,\"course\" c where stu.\"id\"=sc.\"student_id\" and c.\"id\"=sc.\"course_id\" and stu.\"name\" in ('student1','student2','student3','student4','student5','student6','student7','student8','student9') order by stu.\"id\" ) row_ where rownum <= 6) where rownum_ > 3");
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDateTime.parse("1982-05-08 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        compared.setCourse(new Course());
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDateTime.parse("1982-06-08 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        compared.setCourse(new Course());
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDateTime.parse("1982-07-08 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        compared.setCourse(new Course());
    ...
    public void testQueryListOne2ManyPage() {
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDateTime.parse("1982-03-08 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        compared.setCourseList(new ArrayList<>());
        course = new Course();
        course.setId(12);
        course.setName("course12");
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDateTime.parse("1982-04-08 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        compared.setCourseList(new ArrayList<>());
        course = new Course();
        course.setId(11);
    ...
    public void testJavaBeanInherit() {
        ...
        myStudent.setAge(12);
        myStudent.setBirthDay(LocalDateTime.parse("2021-03-15 00:00:00", CTime.DTF_YMD_HH_MM_SS));
        ...
        DbContext.setGenerateIDForInsert("id","SEQ_STUDENT_ID",true);
        ret = MDbUtils.insertBy(DbPoolName, myStudent);

        Assert.equal(sql.toString(), "select \"SEQ_STUDENT_ID\".nextval from dual;insert into \"student\" (\"age\",\"birth_day\",\"id\",\"name\") values(12,to_date('2021-03-15 00:00:00','yyyy-mm-dd hh24:mi:ss'),14,'xyz')");
        sql.setLength(0);
        ...
        Assert.equal(sql.toString(), "update \"student\"  set \"age\"=12,\"birth_day\"=to_date('2021-03-15 00:00:00','yyyy-mm-dd hh24:mi:ss'),\"id\"=14 where \"name\"='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
        MyStudent student = MDbUtils.queryOneBy(DbPoolName, myStudent);

        Assert.equal(sql.toString(), "select * from \"student\"  where \"age\"=12 and \"birth_day\"=to_date('2021-03-15 00:00:00','yyyy-mm-dd hh24:mi:ss') and \"id\"=14 and \"name\"='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
