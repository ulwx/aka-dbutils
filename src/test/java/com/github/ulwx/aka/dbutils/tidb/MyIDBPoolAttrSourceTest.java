...
public class MyIDBPoolAttrSourceTest implements IDBPoolAttrSource {
    ...
    public void configProperties(Map<String, String> masterProperties,
        ...
        try {
            MDbUtils.queryOneBy("tidb/dbpool.xml#db_teacher", new Teacher());
        }catch (Exception e){
            log.error("",e);
        }

        masterProperties.put("driverClassName","com.mysql.cj.jdbc.Driver");
        masterProperties.put("url","jdbc:mysql://192.168.137.211:4000/db_teacher?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true");
        ...
        slave1.put("url","jdbc:mysql://192.168.137.211:4000/db_teacher_slave1?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true");
        ...
        slave2.put("url","jdbc:mysql://192.168.137.211:4000/db_teacher_slave2?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false&allowMultiQueries=true");
