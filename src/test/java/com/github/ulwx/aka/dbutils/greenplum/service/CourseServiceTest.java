package com.github.ulwx.aka.dbutils.greenplum.service;
...
import com.github.ulwx.aka.dbutils.greenplum.dao.db_student.CourseDao;
import com.github.ulwx.aka.dbutils.greenplum.dao.db_teacher.TeacherDao;
...
public class CourseServiceTest {
    ...
    public static String DbPoolName_Student = "greenplum/dbpool.xml#db_student";
    public static String DbPoolName_Teacher= "greenplum/dbpool.xml#db_teacher";
    @Before
    public void setup(){
    ...
    public void testTransactionManager(){
        ...
        DbContext.setDBInterceptor(new DBInterceptor() {
            @Override
            public void postDbOperationExeute(DataBase dataBase, Method interceptedMethod, Object result, Exception exception, String debugSql,long exeTime) {
