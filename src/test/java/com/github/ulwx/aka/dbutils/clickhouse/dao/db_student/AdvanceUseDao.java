...
public class AdvanceUseDao {
    ...
    public void testUpdate() {
        ...
        Assert.equal(sql.toString(), "ALTER TABLE student UPDATE name='add', age=18 where id=1");
        Assert.equal(ret, 1);
    ...
    public void testVarSubstitution() {
        ...
        DbContext.removeDebugSQLListener();
        Assert.equal(sql.toString(), "ALTER TABLE  student UPDATE name='add''a', age=18 where id=1 or id in(1,2,3) or name like '%stu''b'");
        Assert.equal(ret, 1);
