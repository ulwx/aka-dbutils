package com.github.ulwx.aka.dbutils.sqlite3.dao.db_student;
...
import com.github.ulwx.aka.dbutils.sqlite3.Utils;
import com.github.ulwx.aka.dbutils.sqlite3.domain.cus.MyStudent;
import com.github.ulwx.aka.dbutils.sqlite3.domain.cus.One2ManyStudent;
import com.github.ulwx.aka.dbutils.sqlite3.domain.cus.One2OneStudent;
...
public class StudentDao {
    public static String DbPoolName = "sqlite3/dbpool.xml#db_student";
    ...
    public void testQueryListOne2One() {
        ...
        compared.setAge(40);
        compared.setBirthDay(LocalDate.parse("1980-10-08", CTime.DTF_YMD).format(CTime.DTF_YMD));
        ...
        compared.getCourse().setCreatime(LocalDateTime.parse("2021-03-15 22:31:48", CTime.DTF_YMD_HH_MM_SS).format(CTime.DTF_YMD_HH_MM_SS));
        ...
        compared.setAge(39);
        compared.setBirthDay(LocalDate.parse("1981-11-01", CTime.DTF_YMD).format(CTime.DTF_YMD));
        compared.setCourse(new Course());
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDate.parse("1982-10-08", CTime.DTF_YMD).format(CTime.DTF_YMD));
        compared.setCourse(new Course());
    ...
    public void testQueryListOne2OnePage() {
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDate.parse("1982-05-08", CTime.DTF_YMD).format(CTime.DTF_YMD));
        compared.setCourse(new Course());
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDate.parse("1982-06-08", CTime.DTF_YMD).format(CTime.DTF_YMD));
        compared.setCourse(new Course());
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDate.parse("1982-07-08", CTime.DTF_YMD).format(CTime.DTF_YMD));
        compared.setCourse(new Course());
    ...
    public void testQueryListOne2Many() {
        ...
        course.setCreatime(LocalDateTime.parse("2021-03-15 22:31:48", CTime.DTF_YMD_HH_MM_SS).format(CTime.DTF_YMD_HH_MM_SS));
    ...
    public void testQueryListOne2ManyPage() {
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDate.parse("1982-03-08", CTime.DTF_YMD).format(CTime.DTF_YMD));
        compared.setCourseList(new ArrayList<>());
        course = new Course();
        course.setId(12);
        course.setName("course12");
        ...
        compared.setAge(38);
        compared.setBirthDay(LocalDate.parse("1982-04-08", CTime.DTF_YMD).format(CTime.DTF_YMD));
        compared.setCourseList(new ArrayList<>());
        course = new Course();
        course.setId(11);
    ...
    public void testJavaBeanInherit() {
        ...
        myStudent.setAge(12);
        myStudent.setBirthDay(LocalDate.parse("2021-03-15", CTime.DTF_YMD).format(CTime.DTF_YMD));
        ...
        Assert.equal(sql.toString(), "select * from `student`  where `age`=12 and `birth_day`='2021-03-15' and `name`='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
