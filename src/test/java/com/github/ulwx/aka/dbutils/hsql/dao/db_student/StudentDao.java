...
import com.github.ulwx.aka.dbutils.hsql.domain.cus.MyStudent;
import com.github.ulwx.aka.dbutils.hsql.domain.cus.One2ManyStudent;
import com.github.ulwx.aka.dbutils.hsql.domain.cus.One2OneStudent;
...
public class StudentDao {
    public static String DbPoolName = "hsql/dbpool.xml#db_student";
    ...
    public void testQueryListOne2OnePage() {
        ...
        DbContext.removeDebugSQLListener();
        Assert.equal(sql.toString(),
                "select count(1) from \"student\" stu,\"student_course\" sc,\"course\" c where stu.\"id\"=sc.\"student_id\"and c.\"id\"=sc.\"course_id\" and stu.\"name\" in ('student1','student2','student3','student4','student5','student6','student7','student8','student9');select limit 3 3 stu.\"id\" as \"stu.id\", stu.\"name\" as \"stu.name\", stu.\"age\" as \"stu.age\", stu.\"birth_day\" as \"stu.birth_day\", c.\"id\" as \"c.id\", c.\"name\" as \"c.name\", c.\"class_hours\" as \"c.class_hours\", c.\"teacher_id\" as \"c.teacher_id\", c.\"creatime\" as \"c.creatime\" from \"student\" stu,\"student_course\" sc,\"course\" c where stu.\"id\"=sc.\"student_id\"and c.\"id\"=sc.\"course_id\" and stu.\"name\" in ('student1','student2','student3','student4','student5','student6','student7','student8','student9') order by stu.\"id\"");
    ...
    public void testJavaBeanInherit() {
        ...
        Assert.equal(sql.toString(), "insert into \"student\" (\"age\",\"birth_day\",\"name\") values(12,to_date('2021-03-15','yyyy-mm-dd'),'xyz')");
        sql.setLength(0);
        ...
        Assert.equal(sql.toString(), "update \"student\"  set \"age\"=12,\"birth_day\"=to_date('2021-03-15','yyyy-mm-dd') where \"name\"='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
        MyStudent student = MDbUtils.queryOneBy(DbPoolName, myStudent);

        Assert.equal(sql.toString(), "select * from \"student\"  where \"age\"=12 and \"birth_day\"=to_date('2021-03-15','yyyy-mm-dd') and \"name\"='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
