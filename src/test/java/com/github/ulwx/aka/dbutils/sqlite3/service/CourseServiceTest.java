package com.github.ulwx.aka.dbutils.sqlite3.service;
...
import com.github.ulwx.aka.dbutils.sqlite3.dao.db_student.CourseDao;
import com.github.ulwx.aka.dbutils.sqlite3.dao.db_teacher.TeacherDao;
...
public class CourseServiceTest {
    ...
    public static String DbPoolName_Student = "sqlite3/dbpool.xml#db_student";
    public static String DbPoolName_Teacher= "sqlite3/dbpool.xml#db_teacher";
    @Before
    public void setup(){
    ...
    public void testTransactionWithSavePoint1(){
        ...
        try {
            ...
            String  localDateTime = LocalDateTime.parse("2021-03-18 22:31:40",CTime.DTF_YMD_HH_MM_SS).format(CTime.DTF_YMD_HH_MM_SS);
            course.setCreatime(localDateTime);
            courseDao.testUpdateInTrans(mdb,course);
            mdb.setSavepoint("a123");
            localDateTime = LocalDateTime.parse("2021-03-21 22:31:40",CTime.DTF_YMD_HH_MM_SS).format(CTime.DTF_YMD_HH_MM_SS);
            course.setCreatime(localDateTime);
            courseDao.testUpdateInTrans(mdb,course);
        ...
        queryCourse.setId(course.getId());
        queryCourse= MDbUtils.queryOneBy(DbPoolName_Student,queryCourse);
        Assert.equal(queryCourse.getCreatime(),
                "2021-03-18 22:31:40");
