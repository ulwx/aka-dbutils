...
import com.github.ulwx.aka.dbutils.derby.domain.cus.MyStudent;
import com.github.ulwx.aka.dbutils.derby.domain.cus.One2ManyStudent;
import com.github.ulwx.aka.dbutils.derby.domain.cus.One2OneStudent;
...
public class StudentDao {
    public static String DbPoolName = "derby/dbpool.xml#db_student";
    ...
    public void testJavaBeanInherit() {
        ...
        Assert.equal(sql.toString(), "insert into \"student\" (\"age\",\"birth_day\",\"name\") values(12,date('2021-03-15'),'xyz')");
        sql.setLength(0);
        ...
        Assert.equal(sql.toString(), "update \"student\"  set \"age\"=12,\"birth_day\"=date('2021-03-15') where \"name\"='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
        MyStudent student = MDbUtils.queryOneBy(DbPoolName, myStudent);

        Assert.equal(sql.toString(), "select * from \"student\"  where \"age\"=12 and \"birth_day\"=date('2021-03-15') and \"name\"='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
