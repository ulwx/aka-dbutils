...
public class MyIDBPoolAttrSourceTest implements IDBPoolAttrSource {
    ...
    public void configProperties(Map<String, String> masterProperties,
        ...
        try {
            MDbUtils.queryOneBy("greenplum/dbpool.xml#db_teacher", new Teacher());
        }catch (Exception e){
           log.error("",e);
        }

        masterProperties.put("driverClassName","org.postgresql.Driver");
        masterProperties.put("url","jdbc:postgresql://192.168.137.211:5432/db_teacher?connectTimeout=15");
        masterProperties.put("username","gpadmin");
        masterProperties.put("password","gpadmin");
        ...
        masterProperties.put("minPoolSize","1");
        ...
        slave1.put("url","jdbc:postgresql://192.168.137.211:5432/db_teacher_slave1?connectTimeout=15");
        slave1.put("username","gpadmin");
        slave1.put("password","gpadmin");
        slave1.put("encrypt","0");
        slave1.put("checkoutTimeout","6000");
        slave1.put("idleConnectionTestPeriod","30");
        slave1.put("maxIdleTime","60");
        slave1.put("minPoolSize","1");
        ...
        slave2.put("url","jdbc:postgresql://192.168.137.211:5432/db_teacher_slave2?connectTimeout=15");
        slave2.put("username","gpadmin");
        slave2.put("password","gpadmin");
        slave2.put("encrypt","0");
        slave2.put("checkoutTimeout","6000");
        slave2.put("idleConnectionTestPeriod","30");
        slave2.put("maxIdleTime","60");
        slave2.put("minPoolSize","1");
