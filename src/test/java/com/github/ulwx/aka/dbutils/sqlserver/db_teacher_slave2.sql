/*
 ...
 Source Catalog        : db_teacher_slave2
 Source Schema         : dbo
...
INSERT INTO [dbo].[teacher] ([id], [name]) VALUES (N'1', N'abcd2')
GO
...
-- ----------------------------
ALTER TABLE [dbo].[teacher] ADD CONSTRAINT [PK__teacher__3213E83FD5FDB893] PRIMARY KEY CLUSTERED ([id])
