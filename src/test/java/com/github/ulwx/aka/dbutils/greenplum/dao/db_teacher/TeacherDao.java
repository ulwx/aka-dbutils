package com.github.ulwx.aka.dbutils.greenplum.dao.db_teacher;
...
public class TeacherDao {
    public static String DbPoolName = "greenplum/dbpool.xml#db_teacher";
    ...
    public void testInsert() {
        ...
        try {
            MDbUtils.insertBy(DbPoolName, teacher);//Connect_SlaveServer模式下，更新方法不能在从库上执行
        } catch (Exception e) {
