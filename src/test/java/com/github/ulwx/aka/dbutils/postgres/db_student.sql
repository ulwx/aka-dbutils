...
-- ----------------------------
SELECT setval('"public"."course_id_seq"', max(id), true) from course;


-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."student_course_id_seq"', max(id), true) from student_course;


-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."student_id_seq"', max(id), true) from student;


-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."student_many_courses_id_seq"',  max(id), true) from student_many_courses;


-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."t1_id_seq"',  max(id), true) from t1;


-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."t2_id_seq"',  max(id), true) from t2;
...
-- ----------------------------
ALTER TABLE "public"."student_course" ADD CONSTRAINT "student_course_pkey" PRIMARY KEY ("id");


-- ----------------------------
-- Primary Key structure for table student_many_courses
-- ----------------------------
ALTER TABLE "public"."student_many_courses" ADD CONSTRAINT "student_many_courses_pkey" PRIMARY KEY ("id");
