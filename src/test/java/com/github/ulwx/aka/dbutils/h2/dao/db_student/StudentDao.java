...
import com.github.ulwx.aka.dbutils.h2.domain.cus.MyStudent;
...
public class StudentDao {
    ...
    public void testJavaBeanInherit() {
        ...
        Assert.equal(sql.toString(), "insert into \"student\" (\"age\",\"birth_day\",\"name\") values(12,parsedatetime('2021-03-15','yyyy-MM-dd'),'xyz')");
        sql.setLength(0);
        ...
        Assert.equal(sql.toString(), "update \"student\"  set \"age\"=12,\"birth_day\"=parsedatetime('2021-03-15','yyyy-MM-dd') where \"name\"='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
        MyStudent student = MDbUtils.queryOneBy(DbPoolName, myStudent);

        Assert.equal(sql.toString(), "select * from \"student\"  where \"age\"=12 and \"birth_day\"=parsedatetime('2021-03-15','yyyy-MM-dd') and \"name\"='xyz'");
        sql.setLength(0);
        DbContext.setReflectClass(Student.class);
